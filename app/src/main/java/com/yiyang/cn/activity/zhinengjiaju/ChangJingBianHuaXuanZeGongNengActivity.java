...
public class ChangJingBianHuaXuanZeGongNengActivity extends BaseActivity {
    ...
    public int getContentViewResId() {
        return R.layout.layout_changjingbianhua_xuanze_gongneng;
    }
        ...
        tv_rightTitle.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (StringUtils.isEmpty(changJingZhiXingModel.pro_go_one)) {
                    ...
                    ChangJingYiJianZhiXingActivity.actionStart(mContext, leixing, changJingZhiXingModel);
                    finish();
                }
    ...
    public static void actionStart(Context context, String familyId, String sheBeiId, ChangJingZhiXingModel changJingZhiXingModel, String leiXingSanBiaoShi) {
        Intent intent = new Intent(context, ChangJingBianHuaXuanZeGongNengActivity.class);
