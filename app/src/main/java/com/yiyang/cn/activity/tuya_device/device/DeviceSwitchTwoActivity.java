...
public class DeviceSwitchTwoActivity extends TuyaBaseDeviceActivity {
    ...
    public static void actionStart(Context context, String member_type, String device_id, String ty_device_ccid, String old_name, String room_name) {
        Intent intent = new Intent(context, DeviceSwitchTwoActivity.class);
    ...
    public int getContentViewResId() {
        return R.layout.act_device_switch_two;
    }
    ...
    private void setSwichState() {
        Y.e("开关的状态  " + switchLeft + "     " + switchRight);
        if (switchLeft) {
        ...
        _subscriptions.add(toObservable().observeOn(AndroidSchedulers.mainThread()).subscribe(new Action1<Notice>() {
            ...
            public void call(Notice message) {
                if (message.type == ConstanceValue.MSG_DEVICE_DATA) {
                    ...
                    if (message.devId.equals(ty_device_ccid)) {
                        TuyaDeviceManager.getDeviceManager().device_removed(DeviceSwitchTwoActivity.this);
                    }
    ...
    @OnClick({R.id.rl_switch_left, R.id.rl_switch_right, R.id.ll_quankai, R.id.ll_quanguan, R.id.ll_dingshi})
