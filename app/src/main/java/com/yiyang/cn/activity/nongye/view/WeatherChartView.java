...
public class WeatherChartView extends View {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        mTextSize = a.getDimensionPixelSize(R.styleable.WeatherChartView_WeatherChartViewTextSize,
                (int) (14 * densityText));
        mColorDay = a.getColor(R.styleable.WeatherChartView_WeatherChartViewDayColor,
                getResources().getColor(R.color.colorAccent));
        mColorNight = a.getColor(R.styleable.WeatherChartView_WeatherChartViewNightColor,
                getResources().getColor(R.color.colorPrimary));

        int textColor = a.getColor(R.styleable.WeatherChartView_WeatherChartViewTextColor, Color.WHITE);
        a.recycle();
