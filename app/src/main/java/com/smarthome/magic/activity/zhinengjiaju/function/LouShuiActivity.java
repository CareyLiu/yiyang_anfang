...
//智能家居 门磁
public class LouShuiActivity extends BaseActivity {
...
//        }
        ...
        menCiListAdapter = new MenCiListAdapter(R.layout.item_loushui_list, R.layout.item_loushui_header, mDatas);
        rlvList.setLayoutManager(new LinearLayoutManager(mContext));
        rlvList.setAdapter(menCiListAdapter);


        headerView = View.inflate(mContext, R.layout.loushui_header, null);
    ...
    public int getContentViewResId() {
        return R.layout.layout_loushui;
    }
    ...
    public static void actionStart(Context context, String device_id, String memberType) {
        Intent intent = new Intent(context, LouShuiActivity.class);
