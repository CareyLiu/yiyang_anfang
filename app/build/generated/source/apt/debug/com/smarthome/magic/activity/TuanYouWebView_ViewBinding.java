...
public class TuanYouWebView_ViewBinding implements Unbinder {
  ...
  @UiThread
  public TuanYouWebView_ViewBinding(TuanYouWebView target) {
    this(target, target.getWindow().getDecorView());
  }

  @UiThread
  public TuanYouWebView_ViewBinding(TuanYouWebView target, View source) {
    this.target = target;
  ...
  @CallSuper
  public void unbind() {
    TuanYouWebView target = this.target;
