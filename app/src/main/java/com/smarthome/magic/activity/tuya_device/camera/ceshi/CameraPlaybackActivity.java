package com.smarthome.magic.activity.tuya_device.camera.ceshi;
...
import static com.smarthome.magic.activity.tuya_device.camera.ceshi.Constants.ARG1_OPERATE_FAIL;
import static com.smarthome.magic.activity.tuya_device.camera.ceshi.Constants.ARG1_OPERATE_SUCCESS;
import static com.smarthome.magic.activity.tuya_device.camera.ceshi.Constants.INTENT_P2P_TYPE;
import static com.smarthome.magic.activity.tuya_device.camera.ceshi.Constants.MSG_DATA_DATE;
import static com.smarthome.magic.activity.tuya_device.camera.ceshi.Constants.MSG_DATA_DATE_BY_DAY_FAIL;
import static com.smarthome.magic.activity.tuya_device.camera.ceshi.Constants.MSG_DATA_DATE_BY_DAY_SUCC;
import static com.smarthome.magic.activity.tuya_device.camera.ceshi.Constants.MSG_MUTE;
...
public class CameraPlaybackActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.act_device_camera_playback);
        initView();
        initData();
        initListener();
    }
    ...
    private void queryDayByMonthClick() {
        if (!mCameraP2P.isConnecting()) {
            Y.t("please connect device first");
            return;
        }
