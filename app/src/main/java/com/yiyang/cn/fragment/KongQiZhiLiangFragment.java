...
public class KongQiZhiLiangFragment extends Fragment {
    ...
    public KongQiZhiLiangFragment(List<KongQiJianCeModel.DataBean.GdListBean> kongQiJianCeList, String type) {
    ...
    private void initData() {
        ...
        for (int i = 0; i < kongQiJianCeList.size(); i++) {
            ...
            entries.add(new Entry(Float.valueOf(strHeng), Float.valueOf(kongQiJianCeList.get(i).getGd_air_quality())));
        }
...
//        entries.add(new Entry(4, 8));
    ...
    private void setDataStyle(List<Entry> entries) {
        ...
        //  折线的颜色
        dataSet.setFillColor(Color.parseColor("#58AABE"));
        //  填充色的颜色
        dataSet.setColor(Color.parseColor("#58AABE"));
        //  折线的宽度
        ...
        //  设置圆的背景颜色
        dataSet.setCircleColor(Color.parseColor("#58AABE"));
        //  设置数值字体大小
        dataSet.setValueTextSize(13);
        //  设置数值字体颜色
        dataSet.setValueTextColor(Color.parseColor("#58AABE"));
        //  设置折线的显示模式
