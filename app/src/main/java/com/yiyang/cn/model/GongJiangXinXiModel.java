...
public class GongJiangXinXiModel {
    ...
    public static class DataBean {
         ...
         * ir_inst_name :
         * addr : 吉林省长春市南关区电缆街58号靠近惠成汽车电器连锁培训基地
         * ir_column_category :
         * ir_column_type_name :
         * ir_inst_device :
         * ir_industry_type :
