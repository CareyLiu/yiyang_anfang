...
import com.smarthome.magic.activity.tuya_camera.utils.WifiReceiver;
...
public class TuyaDevicePeiwangActivity extends BaseActivity {
    ...
    public static void actionStart(Context context) {
        Intent intent = new Intent(context, TuyaDevicePeiwangActivity.class);
    ...
    public int getContentViewResId() {
        return R.layout.act_device_peiwang;
    }
