...
public class TongYongShuRuDIalog implements View.OnClickListener {
    ...
    public TongYongShuRuDIalog(@NonNull Context context, ShuRuInterView shuRuInterView, String strShuRu) {
        mContext = context;
