...
public class NongshijihuaActivity extends BaseActivity {
    ...
    public static void actionStart(Context context) {
        Intent intent = new Intent(context, NongshijihuaActivity.class);
    ...
    private void initAdapdter() {
        ...
        jidiListAdapter = new JidiListAdapter(R.layout.nongye_item_nongshijihua, jidiListModels);
