...
public class TuanGouZhiFuActivity_ViewBinding implements Unbinder {
  ...
  @UiThread
  public TuanGouZhiFuActivity_ViewBinding(TuanGouZhiFuActivity target) {
    this(target, target.getWindow().getDecorView());
  }

  @UiThread
  public TuanGouZhiFuActivity_ViewBinding(TuanGouZhiFuActivity target, View source) {
    this.target = target;
  ...
  @CallSuper
  public void unbind() {
    TuanGouZhiFuActivity target = this.target;
