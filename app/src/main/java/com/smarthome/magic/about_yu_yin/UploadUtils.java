package com.smarthome.magic.about_yu_yin;
...
public class UploadUtils  {
    ...
    private static final String APPID = "5fc33e7b";
    private static final String X_NAMESPACE = "OS8569425439";
    private static final String ACCOUNTKEY = "66a0643439d540d1841c0222d35c7a8d";
    public UploadUtils() {

        Map<String, String> header = buildHeader();
        String uploadBody = null;
        try {
            uploadBody = buildUploadBody();
