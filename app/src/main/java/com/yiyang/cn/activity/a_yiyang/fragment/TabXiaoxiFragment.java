...
public class TabXiaoxiFragment extends BaseFragment {
    ...
    private void initAdapter() {
        ...
        xiaoxiAdapter.setOnItemClickListener(new BaseQuickAdapter.OnItemClickListener() {
            @Override
            public void onItemClick(BaseQuickAdapter adapter, View view, int position) {
                ...
                RongIM.getInstance().startConversation(getContext(), conversationType, targetId, instName, bundle);
            }
        });
    }
