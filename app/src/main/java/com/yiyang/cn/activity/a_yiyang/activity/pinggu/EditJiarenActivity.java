...
public class EditJiarenActivity extends BaseActivity implements TakePhoto.TakeResultListener, InvokeListener {
    ...
    public static void actionStart(Context context, JiashuModel model, int pos) {
        Intent intent = new Intent(context, EditJiarenActivity.class);
    ...
    private void setData() {
        headImgPath = model.getHeadImgPath();
        name = model.getName();
        sex = model.getSex();
        birthday = model.getBirthday();
        phone = model.getPhone();
        guanxi = model.getGuanxi();
        shengao = model.getShengao();
        tizhong = model.getTizhong();
        xuexing = model.getXuexing();
        wenhuachengdu = model.getWenhuachengdu();
        hunyinzhuangkuang = model.getHunyinzhuangkuang();
        zhiyeqingkuang = model.getZhiyeqingkuang();
        yanglaobaoxian = model.getYanglaobaoxian();
        yiliaobaoxian = model.getYiliaobaoxian();
        gaoxueya = model.getGaoxueya();
        xinzangbing = model.getXinzangbing();
        is_yinjiu = model.getIs_yinjiu();
        is_xiya = model.getIs_xiya();
        is_zili = model.getIs_zili();
        xingdongnengli = model.getXingdongnengli();
        yuyannengli = model.getYuyannengli();
        is_chidai = model.getIs_chidai();
        aihao = model.getAihao();
    }

    private void initData() {
        Glide.with(mContext).load(model.getHeadImgPath()).apply(RequestOptions.circleCropTransform()).into(iv_head);

        tv_guanxi.setText(model.getGuanxi());
        ...
        tv_xinzaobing.setText(model.getXinzangbing());
    ...
    private void clickSave() {
        ...
        notice.type = ConstanceValue.MSG_YIYANG_EDITJAREN;
        notice.content = model;
        notice.pinggu_id = pos;
        sendRx(notice);
        finish();
    }
}
