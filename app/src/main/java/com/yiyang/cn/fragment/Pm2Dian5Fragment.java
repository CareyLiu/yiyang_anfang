...
public class Pm2Dian5Fragment extends Fragment {
    ...
    public Pm2Dian5Fragment(List<KongQiJianCeModel.DataBean.GdListBean> kongQiJianCeList, String type) {
    ...
    private void setAxis() {
        ...
        yl.setGranularity(100);
        //  设置左边Y轴最小单位为0
        yl.setAxisMinimum(0);
        yl.setAxisMaximum(1000);
    ...
    private void initData() {
        ...
        for (int i = 0; i < kongQiJianCeList.size(); i++) {
            ...
            entries.add(new Entry(Float.valueOf(strHeng), Float.valueOf(kongQiJianCeList.get(i).getGd_particulate_matter())));
        }
...
//        entries.add(new Entry(4, 8));
    ...
    private void setDataStyle(List<Entry> entries) {
        ...
        //  折线的颜色
        dataSet.setFillColor(Color.parseColor("#F89171"));
        //  填充色的颜色
        dataSet.setColor(Color.parseColor("#F89171"));
        //  折线的宽度
        ...
        //  设置圆的背景颜色
        dataSet.setCircleColor(Color.parseColor("#F89171"));
        //  设置数值字体大小
        dataSet.setValueTextSize(13);
        //  设置数值字体颜色
        dataSet.setValueTextColor(Color.parseColor("#F89171"));
        //  设置折线的显示模式
