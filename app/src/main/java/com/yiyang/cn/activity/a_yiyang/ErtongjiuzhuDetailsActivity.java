...
public class ErtongjiuzhuDetailsActivity extends BaseActivity {
    ...
    public int getContentViewResId() {
        return R.layout.yiyang_act_ertongjiuzhu_details;
    }
    ...
    public static void actionStart(Context context) {
        Intent intent = new Intent(context, ErtongjiuzhuDetailsActivity.class);
