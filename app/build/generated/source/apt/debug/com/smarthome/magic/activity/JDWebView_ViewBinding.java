...
public class JDWebView_ViewBinding implements Unbinder {
  private JDWebView target;

  @UiThread
  public JDWebView_ViewBinding(JDWebView target) {
    this(target, target.getWindow().getDecorView());
  }

  @UiThread
  public JDWebView_ViewBinding(JDWebView target, View source) {
    this.target = target;
