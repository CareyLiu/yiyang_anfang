...
public class TaoKeListAdapter extends BaseQuickAdapter<TaoKeDetailList.DataBean, BaseViewHolder> {

    public TaoKeListAdapter(int layoutResId, @Nullable List<TaoKeDetailList.DataBean> data) {
